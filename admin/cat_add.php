<?php
  ...
  if ($_POST) {
    if (empty($_POST['name']) || empty($_POST['description'])) {
      ...
      $result = $stmt->execute(array(':name'=>$_POST['name'],':description'=>$_POST['description']));

      if ($result) echo "<script>alert('New Record is added!');window.location.href='category.php';</script>";
    }
  }
